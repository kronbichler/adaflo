...
struct FlowParameters
{
  ...
  enum PhysicalType  {incompressible, incompressible_stationary, stokes} physical_type;
  ...
  enum Linearization {coupled_implicit_newton,
  ...
  enum PreconditionVelocity { u_ilu, u_ilu_scalar, u_amg_linear, u_amg } precondition_velocity;
  enum PreconditionPressure { p_mass_diag, p_mass_ilu } precondition_pressure;
