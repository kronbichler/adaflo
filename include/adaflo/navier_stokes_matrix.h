...
template <int dim>
inline bool
adaflo::NavierStokesMatrix<dim>::use_variable_coefficients() const
{
...
template <int dim>
inline const typename adaflo::NavierStokesMatrix<dim>::velocity_stored *
adaflo::NavierStokesMatrix<dim>::begin_linearized_velocities(
